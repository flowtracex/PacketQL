...
// RFC1918 private ranges — parsed once at package init
var (
	_, private8, _  = net.ParseCIDR("10.0.0.0/8")
	_, private12, _ = net.ParseCIDR("172.16.0.0/12")
...
func isPrivateIP(ipStr string) bool {
	...
	return private8.Contains(ip) || private12.Contains(ip) || private16.Contains(ip)
}
