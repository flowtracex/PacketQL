...
// DPD represents a normalized dpd event following the three-layer model:
// 1) Conditional enrichment (controlled per log type via normalization.json enrich flags)
// 2) Normalized/promoted fields (from normalization.json mapping)
// 3) Unmapped raw fields (from schema.json, NOT in normalization.json)
// 4) raw_log (complete original JSON)
type DPD struct {
	...
	// These are raw fields that were NOT promoted
	// =========================
	Analyzer string `parquet:"analyzer"` // Not mapped
	FailureReason string `parquet:"failure_reason"` // Not mapped
...
// FILES represents a normalized files event following the three-layer model:
// 1) Conditional enrichment (controlled per log type via normalization.json enrich flags)
// 2) Normalized/promoted fields (from normalization.json mapping)
// 3) Unmapped raw fields (from schema.json, NOT in normalization.json)
// 4) raw_log (complete original JSON)
type FILES struct {
	...
	// =========================
	EventTime int64 `parquet:"event_time"` // Promoted from: ts
	FlowID string `parquet:"flow_id"` // Promoted from: fuid
	...
	// These are raw fields that were NOT promoted
	// =========================
	Analyzers string `parquet:"analyzers"` // Not mapped
	ConnUids string `parquet:"conn_uids"` // Not mapped
	Depth int32 `parquet:"depth"` // Not mapped
	Duration float64 `parquet:"duration"` // Not mapped
	Extracted string `parquet:"extracted"` // Not mapped
	ExtractedCutoff bool `parquet:"extracted_cutoff"` // Not mapped
	ExtractedSize int32 `parquet:"extracted_size"` // Not mapped
	Filename string `parquet:"filename"` // Not mapped
	IsOrig bool `parquet:"is_orig"` // Not mapped
	LocalOrig bool `parquet:"local_orig"` // Not mapped
	Md5 string `parquet:"md5"` // Not mapped
	MimeType string `parquet:"mime_type"` // Not mapped
	MissingBytes int32 `parquet:"missing_bytes"` // Not mapped
	OverflowBytes int32 `parquet:"overflow_bytes"` // Not mapped
	ParentFuid string `parquet:"parent_fuid"` // Not mapped
	RxHosts string `parquet:"rx_hosts"` // Not mapped
	SeenBytes int32 `parquet:"seen_bytes"` // Not mapped
	Sha1 string `parquet:"sha1"` // Not mapped
	Sha256 string `parquet:"sha256"` // Not mapped
	Source string `parquet:"source"` // Not mapped
	Timedout bool `parquet:"timedout"` // Not mapped
	TotalBytes int32 `parquet:"total_bytes"` // Not mapped
	TxHosts string `parquet:"tx_hosts"` // Not mapped
...
// NOTICE represents a normalized notice event following the three-layer model:
// 1) Conditional enrichment (controlled per log type via normalization.json enrich flags)
// 2) Normalized/promoted fields (from normalization.json mapping)
// 3) Unmapped raw fields (from schema.json, NOT in normalization.json)
// 4) raw_log (complete original JSON)
type NOTICE struct {
	...
	// These are raw fields that were NOT promoted
	// =========================
	Actions string `parquet:"actions"` // Not mapped
	Dst string `parquet:"dst"` // Not mapped
	FileDesc string `parquet:"file_desc"` // Not mapped
	FileMimeType string `parquet:"file_mime_type"` // Not mapped
	Fuid string `parquet:"fuid"` // Not mapped
	Msg string `parquet:"msg"` // Not mapped
	N int32 `parquet:"n"` // Not mapped
	Note string `parquet:"note"` // Not mapped
	P int32 `parquet:"p"` // Not mapped
	PeerDescr string `parquet:"peer_descr"` // Not mapped
	Src string `parquet:"src"` // Not mapped
	Sub string `parquet:"sub"` // Not mapped
	SuppressFor float64 `parquet:"suppress_for"` // Not mapped
...
// WEIRD represents a normalized weird event following the three-layer model:
// 1) Conditional enrichment (controlled per log type via normalization.json enrich flags)
// 2) Normalized/promoted fields (from normalization.json mapping)
// 3) Unmapped raw fields (from schema.json, NOT in normalization.json)
// 4) raw_log (complete original JSON)
type WEIRD struct {
	...
	// These are raw fields that were NOT promoted
	// =========================
	Addl string `parquet:"addl"` // Not mapped
	Name string `parquet:"name"` // Not mapped
	Notice bool `parquet:"notice"` // Not mapped
	Peer string `parquet:"peer"` // Not mapped
	Source string `parquet:"source"` // Not mapped
